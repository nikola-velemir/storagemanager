...
public class
    MechanicalComponentModelConfiguration : IEntityTypeConfiguration<
    Domain.MechanicalComponent.Model.MechanicalComponent>
{
    public void Configure(
        Microsoft.EntityFrameworkCore.Metadata.Builders.EntityTypeBuilder<
            Domain.MechanicalComponent.Model.MechanicalComponent> builder)
    {
