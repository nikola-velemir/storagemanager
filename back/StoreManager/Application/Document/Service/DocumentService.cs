    ...
    : IDocumentService
{
    ...
    public Task<byte[]> GeneratePdfFile(Domain.BusinessPartner.Base.Model.BusinessPartner partner, DateOnly dateIssued,
    ...
    public async Task<Domain.Document.Model.Document> UploadExport(
        Domain.BusinessPartner.Base.Model.BusinessPartner partner, DateOnly dateIssued,
